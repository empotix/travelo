...
// ------------------------------------------------------------------------
    ...
    class CI_Pagination
    {
        ...
        var $last_link = '&gt;&gt;';
        var $uri_segment = 3;
        var $full_tag_open = '<div id="paging"><div class="pagingnav"><p>';
        var $full_tag_close = '</p></div></div>';
        var $first_tag_open = '<span>';
        var $first_tag_close = '</span>';
        var $last_tag_open = '<span>';
        var $last_tag_close = '</span>';
        var $first_url = ''; // Alternative URL for the First Page.
        var $cur_tag_open = '<span class="clsActive">';
        var $cur_tag_close = '</span>';
        var $next_tag_open = '<span>';
        var $next_tag_close = '</span>';
        var $prev_tag_open = '<span>';
