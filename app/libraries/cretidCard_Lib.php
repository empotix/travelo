...
//for 3-token -> API_USERNAME,API_PASSWORD,API_SIGNATURE  are needed
    ...
    class cretidCard_Lib extends CI_Config
    {
...
//Check is CC live?
            $is_live = $CI->db->get_where('payments', array('id' => 1))->row()->is_live;

            $cc_user = $CI->db->get_where('payment_details', array('code' => 'CC_USER'))->row()->value;
            $cc_password = $CI->db->get_where('payment_details', array('code' => 'CC_PASSWORD'))->row()->value;
            $cc_key = $CI->db->get_where('payment_details', array('code' => 'CC_SIGNATURE'))->row()->value;

            define('API_USERNAME', $cc_user);
//
             ...
             */
            define('API_PASSWORD', $cc_password);

            /**
              # API_Signature:The Signature associated with the API user. which is generated by paypal.
             */
            define('API_SIGNATURE', $cc_key);
