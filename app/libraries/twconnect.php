<?php
    ...
    class Twconnect extends TwitterOAuth
    {
        ...
        public $tw_profile_image_url = null;
        ...
        {
            $tw_user_info = $this->tw_get('account/verify_credentials');
            $this->tw_user_info = $tw_user_info;
            if ($tw_user_info == '')
            {
                return "no";
                exit;
            }
            $this->tw_profile_image_url = $tw_user_info->profile_image_url;
        ...
        public function twaccount_tweet($msg)
        {

            $msg_array['status'] = $msg;
            $twaccount_tweet = $this->tw_post('statuses/update', $msg_array);
            return $twaccount_tweet;
        }

        public function twaccount_followers()
        {


            $twaccount_followers = $this->tw_get('followers/ids');
            return $twaccount_followers;
        }

        public function twaccount_friends()
        {


            $twaccount_friends = $this->tw_get('friends/ids');
            return $twaccount_friends;
        }

        public function getPermanentToken()
        {
            $ci = & get_instance();
            $tokens = $ci->session->userdata('tw_access_token');
            return $tokens;
        }
        ...
        {
            $ci = & get_instance();
            $tokens = $ci->session->unset_userdata('tw_access_token');
        }
