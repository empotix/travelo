...
<script src="<?php echo js_url(); ?>/edit_listing.js" type="text/javascript"></script>
<script src="<?php echo js_url(); ?>/widgets.js" type="text/javascript"></script>
<script type="text/javascript">
    $(document).ready(function () {

        var list_id = <?php echo $this->uri->segment(3); ?>;
        var dataString = "list_id=" + list_id;

        b_url = "<?php echo base_url() . 'rooms/add_neighbor' ?>";
        $.ajax({
            type: "POST",
            url: b_url,
            data: dataString,
            success: function (data) {
                if (data == "please select neighbor place")
                {
...
<script type="text/javascript">
    ...
    function show() {
        var add = $('#main').text();
        try {
            add_modify = document.getElementById("main1").value;
        ...
        if (add_modify != null)
        {
            if (add_modify_old != add_modify)
            {
                add_modify_old = add_modify;

                add = document.getElementById("main1").value;
                k = 1;
            }
        }
        if (k == 1)
        {
            ...
            $("#spin").html('<img src="<?php echo base_url() . "images/spinner.gif"; ?>">');
            ...
            if (add != '')
            {
                ...
                b_url = "<?php echo base_url() . 'rooms/neighbor' ?>";
                $.ajax({
                    type: "POST",
                    url: b_url,
                    data: dataString,
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        jQuery('.hosting_name').charCounter({
            warningcount: 5,
            inputchanged: function (charsLeft) {
                jQuery(this).siblings('.countvalue:first').html(charsLeft);
            },
            warningenter: function () {
                jQuery(this).siblings('.countvalue:first').addClass('warning');
            },
            warningexit: function () {
                jQuery(this).siblings('.countvalue:first').removeClass('warning');
            },
            limitreached: function () {
                jQuery(this).siblings('.countvalue:first').addClass('error');
            }
        });
    ...
    function change_guests_included() {
        $$('.guests_included').each(function (e) {
            e.innerHTML = $('hosting_guests_included').value;
        });
    }
    ...
    function accommodates_changed() {
        if ($('hosting_person_capacity').value < $('hosting_guests_included').value) {
            ...
            $$('.guests_included').each(function (e) {
                e.innerHTML = $('hosting_person_capacity').value;
            });
        }
    }
    ...
    jQuery(document).ready(function () {
        jQuery('.button').hover(function () {
            jQuery(this).addClass('drop_shadow_soft')
        }, function () {
    ...
    <div id="View_Edit_Heading">
        <div class="heading_content clearfix">
            ...
            <div class="listing_info">
                ...
                <p> <a target="_NEW" class="clsLink2_Bg" href="<?php echo base_url(); ?>rooms/<?php echo $this->uri->segment(3); ?>"><span><?php echo translate("View Listing"); ?></span></a> </p>
        ...
        <div class="View_Edit_Main_Content">
            ...
            <div id="dashboard-content">
                <form name="hosting_edit_form" method="post" id="hosting_edit_form" enctype="multipart/form-data" action="<?php site_url('rooms/update/' . $this->uri->segment(3)); ?>">
                    <div class="Box editlist_Box" id="listing_type_container">
                        <div class="top">
                            <h2 class="step"><?php echo translate("Listing Type"); ?></h2>
                        </div>
                        <div class="middle">
                            <ul id="details">
                                <li>
                                    ...
                                    <div id="form_helper_property_type_id" class="form_helper" style="display:none;">
                                        <p><?php echo translate("What is the property type?"); ?></p>
                                    </div>
                                    <div class="clear"></div>
                                </li>
                                <li>
                                    ...
                                    <select class="fixed-width" id="hosting_room_type" name="room_type">
                                        <option value="Private room"><?php echo translate("Private room"); ?></option>
                                    ...
                                    <div id="form_helper_room_type" class="form_helper" style="display:none;">
                                        <p><?php echo translate("What is the room type?"); ?></p>
                                    </div>
                                    <div class="clear"></div>
                                </li>
                            </ul>
                    ...
                    <!-- box -->
                    <div id="description_language_en" class="editlist_Box Box" style="">
                        <div class="top">
                            <h2 class="step">
                                <?php echo translate("Description"); ?> <span class="language_hint"> (<?php echo translate("English"); ?>)</span> </h2>
                        </div>
                        <div class="middle">
                            <ul id="description">
                                <li class="description_language_section_container">
                                    <ul class="description_language_section">
                                        <li class="section_en">
                                            <label for="hosting_name"> <?php echo translate("Title"); ?><br>
                                            </label>
                                            <input type="text" value="<?php echo $row->title; ?>" name="hosting_descriptions" maxlength="35" id="hosting_descriptions_en_name" class="large charcount hosting_name" style="padding-left:0px; margin-left:12px; border: 1px solid #CCCCCC; border-radius: 3px 3px 3px 3px;">
                                            <span class="countvalue" id="hosting_name_char_count">20</span> <span id="title_message"></span>
                                            <div class="clear"></div>
                                        </li>
                                        <li class="section_en">
                                            <label for="hosting_description" style="vertical-align:top;"><?php echo translate("Description"); ?> <a class="tooltip" title="Note: we automatically filter out any contact information that you provide in your description"><img alt="Questionmark_hover" src="<?php echo base_url(); ?>images/questionmark_hover.png" style="width:16px; height:16px;" /></a> <span class="helper"> <br />
                                                    <br />
                                                    <span style="font-size:13px; font-weight:bold;"><?php echo translate("Tips for writing a great description:"); ?></span> <br />
                                                    <?php echo translate("What makes your place unique?"); ?> <br />
                                                    <?php echo translate("What is your neighborhood like?"); ?> <br />
                                                    <?php echo translate("What is the state of the room offered?"); ?> <br />
                                                </span> </label>
                                            <textarea id="hosting_descriptions_en_description" name="desc" style="margin-left:12px; border: 1px solid #CCCCCC; border-radius: 3px 3px 3px 3px;">
                                                <?php //echo strip_tags($row->desc); ?>
                                                <?php
                                                    //echo  strip_tags(str_replace('[removed]', '', $row->desc));
//echo str_replace('^nl;^',"\n",$row->desc);
                                                    echo $row->desc;
                                                ?>
                                            </textarea>
                    ...
                    <!-- box -->
                    <div class="Box editlist_Box" id="amenities">
                        <div class="top">
                    ...
                    <!-- /box -->
                    <div class="Box editlist_Box" id="details_container">
                        <div class="top">
...
<?php for ($i = 1; $i <= 10; $i++)
    ...
    <?php } ?>
                                    ...
                                    <div id="form_helper_person_capacity" class="form_helper" style="display:none;">
                                        <p><?php echo translate("The Maximum number of guests."); ?></p>
                                    </div>
                                    <div class="clear"></div>
                                </li>
                                <li>
    ...
    <?php } ?>
                                    ...
                                    <div id="form_helper_bedrooms" class="form_helper" style="display:none; width:320px;">
                                        <p><?php echo translate("How many bedrooms, couches, futons, etc. do you offer?"); ?></p>
                                    </div>
                                    <div class="clear"></div>
                                </li>
                                <li>
                                    <label for="hosting_beds"><?php echo translate("Beds"); ?></label>
...
<?php for ($i = 1; $i <= 16; $i++)
    {
        ...
        if ($i == 16)
            echo '+';
        ?> <?php echo translate("bed"); ?><?php if ($i > 1) echo 's'; ?></option>
    <?php } ?>
                                    </select>
                                    <div id="form_helper_beds" class="form_helper" style="display:none; width:320px;">
                                        <p><?php echo translate("How many beds, couches, futons, etc. do you offer?"); ?></p>
                                    </div>
                                    <div class="clear"></div>
                                </li>
                                <li>
                                    <label for="hosting_bed_type"><?php echo translate("Bed type"); ?></label>
                                    <select class="fixed-width" id="hosting_bed_type" name="hosting_bed_type">
                                        <option value="None"><?php echo translate("None"); ?></option>
                                        <option value="Airbed"><?php echo translate("Airbed"); ?></option>
                                        <option value="Futon"><?php echo translate("Futon"); ?></option>
                                        <option value="Pull-out Sofa"><?php echo translate("Pull-out Sofa"); ?></option>
                                        <option value="Couch"><?php echo translate("Couch"); ?></option>
                                        <option value="Real Bed" selected="selected"><?php echo translate("Real Bed"); ?></option>
                                    </select>
                                    <div class="clear"></div>
                                </li>
                                <li class="clearfix">
                                    <label for="hosting_bathrooms"><?php echo translate("Bathrooms"); ?></label>
                                    <select name="hosting_bathrooms" id="hosting_bathrooms" class="fixed-width">
                                        <!--  <option selected="selected" value=""></option>-->
                                        <option value="0">0 <?php echo translate("Bathroom"); ?></option>

                                        <option value="1">1 <?php echo translate("Bathroom"); ?></option>

                                        <option value="2">2 <?php echo translate("Bathrooms"); ?></option>

                                        <option value="3">3 <?php echo translate("Bathrooms"); ?></option>

                                        <option value="4">4 <?php echo translate("Bathrooms"); ?></option>

                                        <option value="5">5 <?php echo translate("Bathrooms"); ?></option>

                                        <option value="6">6 <?php echo translate("Bathrooms"); ?></option>

                                        <option value="7">7 <?php echo translate("Bathrooms"); ?></option>

                                        <option value="8">8 <?php echo translate("Bathrooms"); ?></option>
                                    </select>
                                </li>
                                <li>
                                    <label for="hosting_house_manual" style="vertical-align:top;"><?php echo translate("House Manual"); ?> <br/>
                                        <span class="helper"> <?php echo translate("Private: Only guests with a confirmed reservation will receive this information.  For example, WIFI password, lockbox code, parking information."); ?> </span> </label>
                                    <textarea cols="40" id="hosting_house_manual" name="manual" rows="20" style="border: 1px solid #CCCCCC; border-radius: 3px 3px 3px 3px;"><?php //echo $row->manual;  ?><?php echo strip_tags(str_replace('[removed]', '', $row->manual)); ?></textarea>
                                    <div id="form_helper_house_manual" class="form_helper" style="display:none;"> </div>
                                    <div class="clear"></div>
                                </li>
                                <li class="clearfix">
                                    <label for="hosting_bathrooms"><?php echo translate("Cancellation Policy"); ?></label>
                                    <select name="cancellation_policy" id="cancellation_policy" class="fixed-width">
                                        ...
                                        if ($row->cancellation_policy == "Moderate")
                                        {
                                            echo "selected";
                                        }
                                        ?>>Moderate</option>
                                        <option value="Strict"<?php
                                                if ($row->cancellation_policy == "Strict")
                                                {
                                                    echo "selected";
                                                }
                                        ?>>Strict</option>
                                        <option value="Super Strict"<?php
                                                if ($row->cancellation_policy == "Super Strict")
                                                {
                                                    echo "selected";
                                                }
                                        ?>>Super Strict</option>
                                        <option value="Long Term"<?php
                                                if ($row->cancellation_policy == "Long Term")
                                                {
                                                    echo "selected";
                                                }
                                        ?>>Long Term</option> 
                    ...
                    <!-- box -->
                    <div id="location-information-section" class="Box editlist_Box">
                        <div class="top">
                            <h2 class="step"> <span class="edit_room_icon address"></span> <?php echo translate("Location Information"); ?> <span id="edit_address_message" class="edit-address-message" style="display: none;"
                                                                                                                                                  ...
                                                                                                                                                  data-message-contact="<strong>We just can't seem to find you.</strong><br />If you continue to have problems, please <a href='<?php echo site_url('pages/contact'); ?>'>contact support</a> to change your address."></span> </h2>
                        </div>
                        <div class="map-view">
                            <h3 class="map-description exact"> <span class="protip">
                                    <a onclick="show1();
                                            add();" id="edit-address" href="#" style="display: inline;"><?php echo translate("Edit address"); ?></a> 
                                    <a style="display: none;" id="cancel-edit-address" href="#"> <?php echo translate("Cancel"); ?></a> </span> <?php echo translate("Exact address"); ?> <div id="main" class="address" style="display: inline-block;"><?php echo $row->address; ?></div> </h3>
                            <div class="map-pane" id="private-map"></div>
                        </div>
                        <div class="map-view">
                            <h3 class="map-description public"> <span class="icon"></span><?php echo translate("Public View"); ?> <span class="address editing" style="display: none;"><em><?php echo translate("Currently editing") . '...'; ?></em></span> <span class="address full" data-message-refresh="Refresh the page to see your updated public address"><?php echo $row->address; ?></span>
                                <p><em><?php echo translate("This is how your address appears on your public listing"); ?></em></p>
                            </h3>
                            <div class="map-pane" id="public-map"> </div>
                        </div>
                        <div class="middle">
                            <ul id="location">
                                <li> <label><?php echo translate("Neighborhood place"); ?></label>
                                    <select id="area" name="area" onclick="show();" style="">

                                    </select>
                                    <div id="spin"></div>
                                </li>
                                <li>
                                    <label for="address_street_view"><?php echo translate("Street_Views"); ?> <a class="tooltip" title="By Default we offset the location of your property to protect your privacy.&lt;br /&gt;You may show a more specific Street View location by choosing &quot;Closest to My Address&quot;.&lt;br /&gt;You may also choose to &quot;Hide Street View&quot;."> <img alt="Questionmark_hover" src="<?php echo base_url(); ?>images/questionmark_hover.png" style="width:16px; height:16px;" /></a> </label>
                                    <select class="fixed-width" id="address_street_view" name="street_view">
                                        <option value="0"><?php echo translate("Hide Street View"); ?></option>
                                        <option value="1"><?php echo translate("Nearby (within 2 blocks)"); ?></option>
                                        <option value="2"><?php echo translate("Closest to My Address"); ?></option>
                                    </select>
                                    <a href="#" id="street-view-link" style="display:none"><?php echo translate("View"); ?></a>
                                    <div class="clear"></div>
                                </li>
                                ...
                                <li>
                                    <label for="hosting_directions"><?php echo translate("Directions"); ?></label>
                                    <textarea rows="20" name="hosting_directions" id="hosting_directions" cols="40"><?php //echo $row->directions;   ?><?php echo strip_tags(str_replace('[removed]', '', $row->directions)); ?></textarea>
                                    <div class="clear"></div>
                                </li>
                            </ul>
                            <div class="clear"></div>
                    ...
                    <div class="form-submit" id="submit_new_room">
                        <button style="margin: 10px 10px 0px;" name="commit" id="edit_room_submit_button" class="btn green gotomsg" type="submit"><span><span><?php echo translate("Save"); ?></span></span></button>
...
<noscript>
<div style="display:inline;"> <img height="1" width="1" style="border-style:none;" alt="" src="http://www.googleadservices.com/pagead/conversion/1049231994/?label=FTfiCNDdlgIQ-oSo9AM&amp;guid=ON&amp;script=0"/> </div>
</noscript>
