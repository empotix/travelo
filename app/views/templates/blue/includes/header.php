...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <meta http-equiv="X-UA-Compatible" content="IE=10">
            <meta name="title" content="<?php if (isset($title))
        echo $title;
    else
        echo "";
?>" />
...
?>" />
            <meta http-equiv="X-UA-Compatible" content="IE=edge">
                <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
                    ...
                    <!-- Optional theme -->
                    <!-- <link rel="stylesheet" href="<?php echo css_url(); ?>/bootstrap-theme.css"  type="text/css" >
                    
                    <!-- Optional theme -->
                    <!-- <link rel="stylesheet" href="<?php echo css_url(); ?>/bootstrap-theme.min.css"  type="text/css" >
                                    ...
                                    <div class="headerleft">
                                        <div class="logo">
                                            <a href="<?php echo base_url(); ?>"> <img title="<?php echo $this->dx_auth->get_site_title(); ?>"  src="<?php echo base_url() . 'logo/' . $logo; ?>"> </a> </div>
                                                            <?php if ($this->uri->segment(1) == 'search' || $this->uri->segment(2) == 'new' || $this->uri->segment(2) == 'lys_next')
                                                                {
                                                                    ?>
...
<?php
    ...
    else
    {
        ...
        <?php echo translate('Check out'); ?>
                                                            ...
                                                            {
                                                                ?>
                                                                            <option placeholder="<?php echo $i; ?>"><?php echo $i;
                                                    if ($i == 16)
                                                        echo '+';
                                                    ?> </option>
        <?php } ?>
