...
<div id="book_it" class="container_bg"> 
    ...
    <?php if ($full_cretids == 'off')
        {
            echo form_open('trips/payment/' . $id, array("id" => "PaymentsForm"));
            ?>
            <?php
            $value = '';
            ...
            <div id="payment_options" class="Box bookit_Box">
                ...
                <div class="payment_tabs">
                    ...
                    <div id="payment_method_paypal" class="payment_method_content<?php echo $showP; ?>" title="">
                        ...
                        <div class="currency_alert"><?php echo translate("This payment transacts in"); ?> <?php echo get_currency_symbol1() . get_currency_code(); ?>. <?php echo translate("Your total charge is"); ?> <?php echo get_currency_symbol1() . get_currency_value($amt); ?>.</div>
        ...
        <?php echo translate("After clicking 'Accept reservation request' you will be redirected to PayPal to complete payment."); ?> <span style="font-weight:bold;"> <?php echo translate("You must complete the process or the transaction will not occur."); ?> </span> </p>
                        <div class="clear"></div>
                    </div>
                ...
                <div class="book_it_section" style="padding-bottom:10px;">
                    <p>
                        <input type="button" name="book_it_button" id="p4_book_it_button" class="btn large blue" value="<?php echo translate("Accept reservation request"); ?>"  />
                    </p>
    ...
    { ?>
        ...
        <?php echo form_open('referrals/booking/' . $this->uri->segment(3)); ?>
            ...
            <p>
                <input type="button" name="book_it_button" id="p4_book_it_button" class="Butt_Normal" value="<?php echo translate("Accept reservation request"); ?>"  />
            </p>
        <?php echo form_close(); ?>
    <?php } ?>
    <!-- /Form -->
...
<script type="text/javascript">
    ...
    function update_p4_book_it_button(method) {
        $('p4_book_it_button').value = "Accept reservation request using" + " " + method;
    }
