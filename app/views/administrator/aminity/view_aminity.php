...
<div id="View_Pages">
    ...
    <div class="MainTop_Links clearfix">
        <div class="clsNav">
            <ul>
                <li class="clsNoBorder"><a href="<?php echo admin_url('lists/view_aminity') ?>"><?php echo translate_admin('Add Amenity'); ?></a></li>

            </ul>
        </div>
        <div class="clsTitle">
            <h3><?php echo translate_admin("Manage Amenities"); ?></h3>
        </div>
    </div>
            ...
            <?php
                ...
                if (isset($aminity) and $aminity->num_rows() > 0)
                {
                    foreach ($aminity->result() as $aminity)
                    {
                        ...
                        <tr>
                            <td><input type="checkbox" class="clsNoborder" name="aminitylist[]" id="aminitylist[]" value="<?php echo $aminity->id; ?>"  /> </td>
                            <td><?php echo $i++; ?></td>
                            <td><?php echo $aminity->name; ?></td>			  
                            <td><?php echo $aminity->description; ?></td>

                            <td><a href="<?php echo admin_url('lists/editaminity/' . $aminity->id) ?>">
