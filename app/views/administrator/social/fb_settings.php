...
<script type="text/javascript">
    ...
    $(document).ready(function ()
    {
        $("#form").validate({
            rules: {
                fb_api_id: {required: true},
                fb_api_secret: {required: true}
            },
            messages: {
                fb_api_id: {required: "Please enter the API ID."},
                fb_api_secret: {required: "Please enter the Secret Key."}
            }
...
<div id="Fb_Settings">
    ...
    <form action="<?php echo admin_url('social/fb_settings'); ?>" method="post" id="form" onsubmit="return AIM.submit(this, {'onStart': startCallback, 'onComplete': completeCallback})">
