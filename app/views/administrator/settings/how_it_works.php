<div id="How_It_Works">
    ...
    <form name="howit" action="" method="post" enctype="multipart/form-data">	
        ...
        <table class="table" cellpadding="2" cellspacing="0">
            ...
            <tr>
                <td class="clsName"><?php echo translate_admin('Display_Type'); ?><span class="clsRed">*</span></td>
                <td> 
            ...
            <tr id="media" style="display:<?php echo $showM; ?>;">
                ...
                <td> 
                    <p> <input type="file" name="media"> &nbsp;
                        <a href="<?php echo site_url('info/how_it_works'); ?>" target="_blank"><?php echo translate_admin('Click_Here'); ?></a> <?php echo translate_admin('to see the current video'); ?>.
                </td>
            </tr>	

            <tr id="embed" style="display:<?php echo $showE; ?>;">
                <td class="clsName"><?php echo translate_admin('Embed_Code'); ?><span class="clsRed">*</span></td>
                <td> 
