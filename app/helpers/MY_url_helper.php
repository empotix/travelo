...
// ------------------------------------------------------------------------
    ...
    if (!function_exists('css_url'))
    {
        ...
        function css_url()
        {
            ...
            $CI = & get_instance();
            $uri = $CI->config->site_url() . 'assets/front/css/' . THEME_FOLDER;
    ...
    if (!function_exists('js_url'))
    {
        ...
        function js_url()
        {
            ...
            $CI = & get_instance();
            $uri = $CI->config->site_url() . 'assets/front/js';
    ...
    if (!function_exists('bootstrap_url'))
    {
        ...
        function bootstrap_url()
        {
            ...
            $CI = & get_instance();
            $uri = $CI->config->site_url() . 'assets/front/bootstrap';

            return $uri;
        }

        //Function bootstrap_url End
    }
